...
export const translations: any = {
  fr: {
    title: 'LottoGen Pro',
    subtitle: 'Générateur de combinaisons de loterie professionnel',
    welcome: 'Bienvenue',
    enterName: 'Entrez votre nom',
    saveName: 'Enregistrer',
    generate: 'Générer les numéros',
    generating: 'Génération en cours...',
    numberCount: 'Nombre de numéros par combinaison',
    ...
    select: 'Sélectionner',
    availableCombinations: 'Combinaisons disponibles',
    previous: 'Précédent',
    next: 'Suivant',
    lotteryType: 'Type de loterie',
    numberRange: 'Plage de numéros',
    combinationSize: 'Taille de la combinaison',
    generateCombinations: 'Générer les combinaisons',
    showAllCombinations: 'Voir toutes les combinaisons',
    randomCombinations: 'Combinaisons aléatoires',
    savedCombinations: 'Combinaisons sauvegardées',
    save: 'Sauvegarder',
    delete: 'Supprimer',
    edit: 'Modifier'
  },
  en: {
    title: 'LottoGen Pro',
    subtitle: 'Professional Lottery Combination Generator',
    welcome: 'Welcome',
    enterName: 'Enter your name',
    saveName: 'Save',
    generate: 'Generate numbers',
    generating: 'Generating...',
    numberCount: 'Numbers per combination',
    ...
    randomCombinations: 'Random combinations',
